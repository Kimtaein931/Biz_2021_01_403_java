 ...
 * 
 * 상속을 하게 되면 그 안에 들어있는 모든 method를 복사한 것처럼 그대로 사용할 수 있다.
 */
...
//	private List<CartVO> cartList;
	...
	public void saveCartToFile() {
		// 1. 데이터를 저장할 파일을 생성하기 위하여 FileWriter 클래스를 사용하여 객체 선언
		FileWriter fileWriter = null;

		// 2. FileWriter에 데이터를 전송하기 위하여 PrintWriter 클래스를 사용하여 객체 선언
		 ...
		 *  따라서 FileWriter 객체를 생성할 때는 반드시 try...catch로 묶어야한다.
		 */
		try {
