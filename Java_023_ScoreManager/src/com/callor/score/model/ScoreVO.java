...
public class ScoreVO {
	...
	/*
	 * 기본 생성자 정의
	 * ScoreVO score = new Score() 명령문에서 호출되는 생성자 method
	 */
	public ScoreVO() {
	}
	...
	/*
	 * private으로 선언된 인스턴스 변수에 접근할 getter, setter method 생성
	 */
	...
	/*
	 * Objcet 클래스로부터 상속받은 toString() method를 재정의
	 * 
	 * VO 객체에 데이터를 저장한 후 
	 * 잘 저장되었는지 확인하기 위한 Debuging용 method 재정의
	 * 
	 */
	@Override
