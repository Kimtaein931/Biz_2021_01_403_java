...
public class CartEx_01 {
	 ...
	 * 		CartService의 기능을 업그레이드 해야할 일이 발생했다.
	 * 		CartServiceV1을 그대로 두고 
	 * 		CartServiceV2를 새로 만들어 기존의 기능을 업그레이드 하려고 한다.
	 */
	public static void main(String[] args) {
		...
		// 2. CartServiceV2를 사용
		//	CartVi을 사용하다가 CartV2로 업그레이드하면 method를 호출하는 부분에서
		//	상당히 많은 코드 변경이 수행되어야한다.
		// 	업그레이드를 위해 많은 코드 변경이 이루어지면 그 과정에서
		//	오류가 발생활 확률이 매우 높아진다.
