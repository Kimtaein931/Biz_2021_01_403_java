...
public class Score_03 {
	...
	public static void main(String[] args) {
		...
		// ScoreServiceV2 클래스의 sum() Method를 호출하면서
		// 정수 99, 88, 77을 '전달'한다.
		// sum() method에는 3개의 매개변수가 선언되어 있다.
		// sum() method를 호출할 때 전달하는 값이 3개 미만이거나, 3개보다 많으면
		// '문법오류'가 난다.
		// 다만 sum() method가 각각 다음과 같이 정의돼 있으면 문법오류가 나지 않는다.
