 ...
 * VO 클래스를 사용하여 선언된 vo객체는 인스턴스 변수에 직접 접근할 수 없다.
 ...
 *  읽을 때는 : String name = sVO.getStrName();
 *  
 *  은닉된 인스턴스 변수는 
...
public class ScoreVO {
	 ...
	 * 유효성검사를 수행하고 검사가 통과 되었을 때만 intEng 변수에 
	 * 저장(setting)할 수 있도록 만드는 것
	 */
	...
	/*
	 * 변수에 값을 저장하기 전에 유효성검사를 하기 위해 setIntEng() method를
	 * 통하도록 코드를 변경했다.
	 *  	변수는 private으로 setIntEng() method 선언
	 * intEng 변수의 값을 읽지도 못하는 상황이 발생한다.
	 * intEng 변수의 값을 저장한 후 읽을 수 있어야 되는데
	 * intEng 변수의 값을 읽기 위해서 getIntEng()라는 method를 또하나 선언해둔다. 
	 */
