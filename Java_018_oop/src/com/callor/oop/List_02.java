...
/*
 * List 클래스
 * 배열의 단점을 보완하기 위해서 Java의 JDK에 포함되어 있는 데이터리스트를 관리하기 위한 클래스
 * 
 * 1. 데이터(값)들을 다량으로 저장하는 용도의 객체 생성
 * 2. 배열을 선언하여 값을 저장하는 것과 비슷한 용도
 * 3. 처음 생성할 때 몇 개의 데이터를 저장할 지 결정하지 않고 
 * 4. 필요에 따라서 데이터를 추가, 수정, 삭제 할 수 있다.
 * 		- 배열은 처음 생성한 개수를 변경하면 저장 되어있던 데이터를 사용할 수 없게 된다.
...
public class List_02 {
	...
	public static void main(String[] args) {
		/*
		 * 배열은 처음 생설할 때 지정한 type 이외에는 다른 어떠한 type도 저장할 수 없다. 이미 선언된 배열을 다른 type으로 다시 선언할
		 * 수도 없다.
		 */
...
//		nums[3] = 30f;
		...
		// Generic type은 Integer.Float, Long, Double, String 등을 사용해야한다.
